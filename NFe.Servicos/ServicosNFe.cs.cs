...
{
    public class ServicosNFe : IDisposable
    {
        ...
        public ServicosNFe(ConfiguracaoServico cFgServico, X509Certificate2 certificado = null)
        {
            ...
            if (_controlarCertificado)  // CASO CERTIFICADO SEJA NULL
            {
                _certificado = CertificadoDigital.ObterCertificado(_cFgServico.Certificado);
            }
            else
                _certificado = certificado;
            cFgServico.Certificado.Dt_vencimento = DateTime.Parse(_certificado.GetExpirationDateString());
            ...
            ServicePointManager.SecurityProtocol = _cFgServico.ProtocoloDeSeguranca;
        ...
        public string SalvarArquivoServicoXml(string nomeArquivo, string xmlString)
        {
            ...
            dir = Path.Combine(dir,"Log Serviços", dt.Year.ToString(), dt.Month.ToString());
        ...
        public RetornoNfeStatusServico NfeStatusServico()
        {
            ...
            SalvarArquivoServicoXml(DateTime.Now.ParaDataHoraString() + "-ped-sta.xml", xmlStatus);
            
            if (_cFgServico.ValidarSchemas)
                Validador.Valida(ServicoNFe.NfeStatusServico, _cFgServico.VersaoNfeStatusServico, cfgServico: _cFgServico, xmlStatus);
            ...
            SalvarArquivoServicoXml(DateTime.Now.ParaDataHoraString() + "-sta.xml", retornoXmlString);
        ...
        public RetornoNfeConsultaProtocolo NfeConsultaProtocolo(string chave)
        {
            ...
            SalvarArquivoServicoXml(chave + "-ped-sit.xml", xmlConsulta);
            ...
            SalvarArquivoServicoXml(chave + "-sit.xml", retornoXmlString);
       ...
       */
        ...
        private RetornoNFeAutorizacao NFeAutorizacao4(int idLote, IndicadorSincronizacao indSinc, List<Classes.NFe> nFes, bool compactarMensagem)
        {
            ...
            SalvarArquivoServicoXml(idLote + "-env-lot.xml", xmlEnvio);

            if (_cFgServico.ValidarSchemas)
                Validador.Valida(ServicoNFe.NFeAutorizacao, _cFgServico.VersaoNFeAutorizacao, cfgServico: _cFgServico, xmlEnvio );
            ...
            SalvarArquivoServicoXml(idLote + "-rec.xml", retornoXmlString);
        ...
        public RetornoNFeRetAutorizacao NFeRetAutorizacao(string recibo)
        {
            ...
            SalvarArquivoServicoXml(recibo + "-ped-rec.xml", xmlRecibo);
            ...
            SalvarArquivoServicoXml(recibo + "-pro-rec.xml", retornoXmlString);
