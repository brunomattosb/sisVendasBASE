...
namespace NFe.Utils.Validacao
{
    public static class Validador
    {
        ...
        public static void Valida(ServicoNFe servicoNFe, VersaoServico versaoServico, ConfiguracaoServico cfgServico, string stringXml, bool loteNfe = true)
        {

            Valida(servicoNFe, versaoServico, stringXml, loteNfe, cfgServico.DiretorioSchemas);
        }
        ...
        public static string[] Valida(ServicoNFe servicoNFe, VersaoServico versaoServico, string stringXml, bool loteNfe = true, string pathSchema = null)
        {
            ...
            try
            {
                ...
                while (validator.Read())
                {
                    ...
                    //MessageBox.Show(validator.Value.ToString());
                }
            }
            catch
            {
