...
namespace NFe.Utils
{
    public sealed class ConfiguracaoServico : INotifyPropertyChanged
    {
        ...
        private VersaoServico _versaoLayout = VersaoServico.Versao400;
        private Estado _cUf;
        private TipoAmbiente _tpAmb;
        private TipoEmissao _tpEmis = TipoEmissao.teNormal;
        private ModeloDocumento _modeloDocumento = ModeloDocumento.NFCe;
        private bool _defineVersaoServicosAutomaticamente = true;
        private VersaoServico _versaoRecepcaoEventoCceCancelamento = VersaoServico.Versao400;
        private VersaoServico _versaoRecepcaoEventoEpec = VersaoServico.Versao100;
        private VersaoServico _versaoRecepcaoEventoManifestacaoDestinatario = VersaoServico.Versao100;
        private VersaoServico _versaoNfeRecepcao = VersaoServico.Versao100;
        private VersaoServico _versaoNfeRetRecepcao = VersaoServico.Versao100;
        private VersaoServico _versaoNfeConsultaCadastro = VersaoServico.Versao100;
        private VersaoServico _versaoNfeInutilizacao = VersaoServico.Versao100;
        private VersaoServico _versaoNfeConsultaProtocolo = VersaoServico.Versao400;
        private VersaoServico _versaoNfeStatusServico = VersaoServico.Versao400;
        private VersaoServico _versaoNFeAutorizacao = VersaoServico.Versao400;
        private VersaoServico _versaoNFeRetAutorizacao = VersaoServico.Versao400;
        private VersaoServico _versaoNFeDistribuicaoDFe = VersaoServico.Versao100;
        private VersaoServico _versaoNfeConsultaDest = VersaoServico.Versao100;
        private VersaoServico _versaoNfeDownloadNf = VersaoServico.Versao100;
        private VersaoServico _versaoNfceAministracaoCsc = VersaoServico.Versao100;
