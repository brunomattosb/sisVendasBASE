...
namespace NFe.Utils.NFe
{
    ...
    {
        private static ConfiguracaoServico config = new ConfiguracaoServico();
        /// <summary>
        ...
        public static string CarregarDeArquivoXmlTeste(this Classes.NFe nfe, string arquivoXml)
        {
            var s = FuncoesXml.ObterNodeDeArquivoXml(typeof(Classes.NFe).Name, arquivoXml);
            return s;
        }
        ...
        public static Classes.NFe Valida(this Classes.NFe nfe, ConfiguracaoServico cfgServico = null)
        {
            ...
            if (versao < 3)
                Validador.Valida(ServicoNFe.NfeRecepcao, config.VersaoNfeRecepcao, config, xmlNfe, false );
            if (versao >= 3)
                Validador.Valida(ServicoNFe.NFeAutorizacao, config.VersaoNFeAutorizacao, config, xmlNfe, false);
